...
assert.match(html, /smart-print-core\.js\?v=commercial-1-0-5-r36-p0-2b-boot-grace-fix/);
...
assert.equal(manifest.start_url, './?v=commercial-1-0-5-r36-p0-2b-boot-grace-fix');
