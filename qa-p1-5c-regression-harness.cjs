...
assert.match(html, /smart-print-core\.js\?v=commercial-1-0-5-r37-2-mvp-certification/);
...
assert.equal(manifest.start_url, './?v=commercial-1-0-5-r37-2-mvp-certification');
