...
const assetVersion = 'mvp-launch-v16-2-p0-r1';
...
assert(app.includes("const APP_RELEASE_VERSION = '1.0.1-p0'") && app.includes('APP_VISIBLE_VERSION') && app.includes('class="brandSlogan">Control total de tu negocio</small>'));
