...
assert(styles.includes('assets/logo.png?v=commercial-1-0-5-r34-workers') && styles.includes('assets/banner-click360-home.png?v=commercial-1-0-5-r34-workers'));
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r34-workers'"));
