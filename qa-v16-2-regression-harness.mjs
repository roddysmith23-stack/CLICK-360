...
assert(styles.includes('assets/logo.png?v=commercial-1-0-5-r38-mvp-candidate') && styles.includes('assets/banner-click360-home.png?v=commercial-1-0-5-r38-mvp-candidate'));
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r38-mvp-candidate'"));
