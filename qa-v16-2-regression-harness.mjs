...
assert(styles.includes('assets/logo.png?v=commercial-1-0-5-r37-2-2-shary-cloud-hydration-fix') && styles.includes('assets/banner-click360-home.png?v=commercial-1-0-5-r37-2-2-shary-cloud-hydration-fix'));
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r37-2-2-shary-cloud-hydration-fix'"));
