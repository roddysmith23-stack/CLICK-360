...
assert(styles.includes('assets/logo.png?v=commercial-1-0-5-r37-2-mvp-certification') && styles.includes('assets/banner-click360-home.png?v=commercial-1-0-5-r37-2-mvp-certification'));
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r37-2-mvp-certification'"));
