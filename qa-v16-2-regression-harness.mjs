...
assert(styles.includes('assets/logo.png?v=commercial-1-0-5-r13') && styles.includes('assets/banner-click360-home.png?v=commercial-1-0-5-r13'));
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r13'"));
