...
assert(styles.includes('assets/logo.png?v=mvp-launch-v16-2-p2-web-safe-r1') && styles.includes('assets/banner-click360-home.png?v=mvp-launch-v16-2-p2-web-safe-r1'));
assert(worker.includes("const CACHE = 'click360-mvp-launch-v16-2-p2-web-safe-r1'"));
