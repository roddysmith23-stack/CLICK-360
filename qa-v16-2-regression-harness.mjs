...
assert(styles.includes('assets/logo.png?v=mvp-launch-v16-2-p1-r2') && styles.includes('assets/banner-click360-home.png?v=mvp-launch-v16-2-p1-r2'));
assert(worker.includes("const CACHE = 'click360-mvp-launch-v16-2-p1-r2'"));
