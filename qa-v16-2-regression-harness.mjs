...
assert(styles.includes('assets/logo.png?v=commercial-1-0-5-r37-2-4-real-customer-journey') && styles.includes('assets/banner-click360-home.png?v=commercial-1-0-5-r37-2-4-real-customer-journey'));
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r37-2-4-real-customer-journey'"));
