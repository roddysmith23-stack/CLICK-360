...
assert(app.includes("commercial-1-0-5-r32"));
assert(firebase.includes("commercial-1-0-5-r32"));
assert(runtime.includes("commercial-1-0-5-r32"));
assert(sw.includes("commercial-1-0-5-r32"));
