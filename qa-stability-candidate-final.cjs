...
assert(app.includes("commercial-1-0-5-r33"));
assert(firebase.includes("commercial-1-0-5-r33"));
assert(runtime.includes("commercial-1-0-5-r33"));
assert(sw.includes("commercial-1-0-5-r33"));
