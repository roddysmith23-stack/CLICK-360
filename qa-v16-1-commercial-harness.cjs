...
assert.equal(domain.APP_VERSION, '16.1.0');
...
assert(html.includes('vendor/lucide.min.js?v=mvp-launch-v16-1-r1'));
assert(css.includes('@media(max-width:340px)') && css.includes('@media(max-width:430px)'));
assert(worker.includes("const CACHE = 'click360-mvp-launch-v16-1-r1'"));
