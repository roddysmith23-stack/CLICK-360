...
assert.match(html, /p2-restaurant-domain\.js\?v=commercial-1-0-5-r37-2-4-real-customer-journey/, 'restaurant domain is included in the release HTML');
assert.match(html, /p2-logistics-domain\.js\?v=commercial-1-0-5-r37-2-4-real-customer-journey/, 'logistics domain is included in the release HTML');
