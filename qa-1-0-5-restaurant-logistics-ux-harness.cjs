...
assert.match(html, /p2-restaurant-domain\.js\?v=commercial-1-0-5-r37-2-logistics-worker-permissions/, 'restaurant domain is included in the release HTML');
assert.match(html, /p2-logistics-domain\.js\?v=commercial-1-0-5-r37-2-logistics-worker-permissions/, 'logistics domain is included in the release HTML');
