...
assert.match(html, /p2-restaurant-domain\.js\?v=commercial-1-0-5-r19/, 'restaurant domain is included in the release HTML');
assert.match(html, /p2-logistics-domain\.js\?v=commercial-1-0-5-r19/, 'logistics domain is included in the release HTML');
