...
assert.match(html, /p2-restaurant-domain\.js\?v=commercial-1-0-5-r31/, 'restaurant domain is included in the release HTML');
assert.match(html, /p2-logistics-domain\.js\?v=commercial-1-0-5-r31/, 'logistics domain is included in the release HTML');
