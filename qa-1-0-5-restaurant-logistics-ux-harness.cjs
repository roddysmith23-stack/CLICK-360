...
assert.match(html, /p2-restaurant-domain\.js\?v=commercial-1-0-5-r37-stable-ga/, 'restaurant domain is included in the release HTML');
assert.match(html, /p2-logistics-domain\.js\?v=commercial-1-0-5-r37-stable-ga/, 'logistics domain is included in the release HTML');
