...
assert(app.includes("const APP_RELEASE_VERSION = '1.0.5-stability.1'"), 'candidate app version is current');
assert(runtime.includes("const APP_VERSION = '1.0.5-stability.1'"), 'runtime candidate version is current');
