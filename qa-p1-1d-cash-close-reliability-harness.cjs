...
assert(app.includes("const APP_RELEASE_VERSION = '1.0.5-p2-web-safe'"), 'candidate app version is current');
assert(runtime.includes("const APP_VERSION = '1.0.5-p2-web-safe'"), 'runtime candidate version is current');
