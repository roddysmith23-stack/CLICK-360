...
assert(app.includes("const APP_ASSET_VERSION = 'commercial-1-0-5-r32'"), 'app asset version matches recovery release');
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r32'"), 'service worker cache matches recovery release');
