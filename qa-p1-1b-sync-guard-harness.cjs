...
assert(app.includes("const APP_RELEASE_VERSION = '1.0.4-p0'"), 'app version is P1.1b candidate');
assert(runtime.includes("const APP_VERSION = '1.0.4-p0'"), 'runtime version is P1.1b candidate');
assert(worker.includes("const CACHE = 'click360-mvp-launch-v16-2-p1-5a-r1'"), 'service worker cache is bumped for P1.1b');
