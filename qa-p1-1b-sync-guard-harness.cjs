...
assert(app.includes("const APP_ASSET_VERSION = 'commercial-1-0-5-r37-2-mvp-certification'"), 'app asset version matches recovery release');
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r37-2-mvp-certification'"), 'service worker cache matches recovery release');
