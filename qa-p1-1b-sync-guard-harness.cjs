...
assert(app.includes("const APP_ASSET_VERSION = 'commercial-1-0-5-r37-2-4-cloud-confirmed-r2'"), 'app asset version matches recovery release');
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r37-2-4-cloud-confirmed-r2'"), 'service worker cache matches recovery release');
