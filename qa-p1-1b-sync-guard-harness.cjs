...
assert(app.includes("const APP_RELEASE_VERSION = '1.0.4-p1'"), 'app version is P1.1b candidate');
assert(runtime.includes("const APP_VERSION = '1.0.4-p1'"), 'runtime version is P1.1b candidate');
assert(worker.includes("const CACHE = 'click360-mvp-launch-v16-2-p1-5b-r1'"), 'service worker cache is bumped for P1.1b');
