...
ok(app.includes("commercial-1-0-5-r33"), 'app.js must report r30');
ok(sw.includes("commercial-1-0-5-r33"), 'service-worker must report r30');
ok(guard.includes("commercial-1-0-5-r33"), 'runtime guard must report r30');
