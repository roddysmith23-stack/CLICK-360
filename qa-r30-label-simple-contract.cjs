...
ok(app.includes("commercial-1-0-5-r32"), 'app.js must report r30');
ok(sw.includes("commercial-1-0-5-r32"), 'service-worker must report r30');
ok(guard.includes("commercial-1-0-5-r32"), 'runtime guard must report r30');
