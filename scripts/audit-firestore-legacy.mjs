...
const report = { generatedAt: new Date().toISOString(), mode: args.fixture ? 'FIXTURE_READ_ONLY' : 'FIREBASE_READ_ONLY', summary, approvedUsers: source.approvedUsers, approvedUsersByEmail: source.approvedUsersByEmail, authUsers: source.authUsers || [], tenants };
