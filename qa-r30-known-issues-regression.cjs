...
assert(app.includes("APP_ASSET_VERSION = 'commercial-1-0-5-r33'"), 'app must run r30');
assert(firebase.includes("APP_ASSET_VERSION = 'commercial-1-0-5-r33'"), 'firebase-service must run r30');
assert(sw.includes("CACHE = 'click360-commercial-1-0-5-r33'"), 'service worker must run r30');
