...
assert('cache offline safe', fs.readFileSync(path.join(__dirname, 'service-worker.js'), 'utf8').includes('click360-commercial-1-0-5-r37-2-2-shary-cloud-hydration-fix'));
