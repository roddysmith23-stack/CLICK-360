...
assert(app.includes("const APP_ASSET_VERSION = 'commercial-1-0-5-r37-2-6-runtime-recovery-r1'"), 'app asset version is current recovery release');
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r37-2-6-runtime-recovery-r1'"), 'service worker cache is current recovery release');
