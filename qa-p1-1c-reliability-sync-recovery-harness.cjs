...
assert(app.includes("const APP_ASSET_VERSION = 'commercial-1-0-5-r37-1-label-engine-hotfix'"), 'app asset version is current recovery release');
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r37-1-label-engine-hotfix'"), 'service worker cache is current recovery release');
