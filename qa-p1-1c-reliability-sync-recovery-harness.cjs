...
assert(app.includes("const APP_ASSET_VERSION = 'commercial-1-0-5-r36-p0-2-reliability-fix'"), 'app asset version is current recovery release');
assert(worker.includes("const CACHE = 'click360-commercial-1-0-5-r36-p0-2-reliability-fix'"), 'service worker cache is current recovery release');
