...
assert(app.includes("const APP_RELEASE_VERSION = '1.0.3-p3'"), 'app version is P1.1c candidate');
assert(runtime.includes("const APP_VERSION = '1.0.3-p3'"), 'runtime version is P1.1c candidate');
assert(worker.includes("const CACHE = 'click360-mvp-launch-v16-2-p1-r3'"), 'service worker cache is bumped for P1.1c');
