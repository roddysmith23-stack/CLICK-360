...
assert(app.includes("const APP_RELEASE_VERSION = '1.0.4-p2'"), 'app version is current candidate');
assert(runtime.includes("const APP_VERSION = '1.0.4-p2'"), 'runtime version is current candidate');
