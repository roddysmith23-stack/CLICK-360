...
mustContain(app, "APP_ASSET_VERSION = 'commercial-1-0-5-r32'", 'app asset version r29');
mustContain(sw, "CACHE = 'click360-commercial-1-0-5-r32'", 'service worker cache r29');
