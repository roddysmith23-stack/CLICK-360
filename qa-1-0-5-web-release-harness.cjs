...
assert.match(app, /APP_ASSET_VERSION = 'commercial-1-0-5-r11'/);
...
assert.match(index, /universal-label-canvas\.js\?v=commercial-1-0-5-r11/);
assert.match(index, /universal-label-editor\.js\?v=commercial-1-0-5-r11/);
assert.match(index, /p2-restaurant-domain\.js\?v=commercial-1-0-5-r11/);
assert.match(index, /p2-logistics-domain\.js\?v=commercial-1-0-5-r11/);
assert.match(worker, /click360-commercial-1-0-5-r11/);
