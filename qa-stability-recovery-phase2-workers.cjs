...
assert(firebase.includes("createdBy: ownerId,\n      appVersion: '16.2.0'"), 'worker invitation must use the V16.2 Firestore contract identifier');
assert(!firebase.includes("createdBy: ownerId,\n      appVersion: '1.0.5'"), 'commercial UI version must not be written into the V16 invitation contract field');
